...
import ch.emineo.roo.reverse.domain.ProductIntegrationTest;
...
privileged aspect ProductIntegrationTest_Roo_IntegrationTest {
    ...
    public void ProductIntegrationTest.testFindProduct() {
        ...
        Assert.assertEquals("Find method for 'Product' returned the incorrect identifier", id, obj.getProductid());
    }
    ...
    public void ProductIntegrationTest.testPersist() {
        ...
        Assert.assertNull("Expected 'Product' identifier to be null", obj.getProductid());
        obj.persist();
        obj.flush();
        Assert.assertNotNull("Expected 'Product' identifier to no longer be null", obj.getProductid());
    }
